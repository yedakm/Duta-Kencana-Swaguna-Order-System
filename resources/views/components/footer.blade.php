    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                <h5 class="fw-bold text-primary mb-3">PT Duta Kencana Swaguna</h5>
            ...
            <div class="col-md-4">
                ...
                <p><i class="fas fa-envelope me-2"></i> admin@PT Duta Kencana Swaguna.web.id</p>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-0">&copy; 2025 PT Duta Kencana Swaguna. All rights reserved.</p>
            </div>
